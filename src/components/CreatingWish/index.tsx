            ...
            <div className={styles.sector}>
                ...
                <div className={styles.addGift}>
                    ...
                    <div className={styles.blocklink}>
                        ...
                        <input className={styles.link} placeholder="Например: https://market.yandex.ru/gift" />
                    </div>
                    <div className={styles.bigblock}>
                        <div className={styles.import}>
                            ...
                            <div className={styles.img}>
                                <label htmlFor="file-upload" className={styles.fileLabel}>
                                    <span>Перетащите сюда файл,</span><br/>
                                    <span className={styles.highlightedText}>нажмите для загрузки</span><br/>
                        ...
                        <div>
                            ...
                            <div className={styles.block3}>
                                ...
                                <input className={styles.comment} placeholder="Ваш комментарий" />
                            </div>
